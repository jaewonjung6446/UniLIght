...
public class UltimateRadialMenuEditor : Editor
{
	...
	void StoreReferences ()
	{
		...
		if( !targ.GetComponent<UltimateRadialMenuInputManager>() && FindObjectOfType<EventSystem>() && !FindObjectOfType<EventSystem>().GetComponent<UltimateRadialMenuInputManager>() )
			Undo.AddComponent( FindObjectOfType<EventSystem>().gameObject, typeof( UltimateRadialMenuInputManager) );
